...
public class Contacts {
  ...
  public boolean equals(Object obj) {
    ...
    if( obj instanceof Contacts == false ){
      return false;
    }

    Contacts c = (Contacts) obj;

    if ( name.equals(c.getName()) || surname.equals(c.getSurname()) || emailLabel.toString().equals(c.emailLabel.toString()) || phoneLabel.toString().equals(c.phoneLabel.toString()) || business.equals(c.getBusiness())){
